...
![Wireframe US05](<../docs/wireflows-mv/US 05P-Seguimiento de Orden Web-Web.png>){width=90%}

![Wireframe US05](<../docs/wireflows-mv/US 05P-Seguimiento de Orden Web-App.png>){width=90%}
...
#### US07 - Consulta de saldo

![Wireframe US07](<../docs/wireflows-mv/US 05P-Seguimiento de Orden Web-Web.png>){width=90%}

![Wireframe US07](<../docs/wireflows-mv/US 05P-Seguimiento de Orden Web-App.png>){width=90%}

#### US09 – Calculador de Grosor
...
#### US16 – Notificacion de recojo

![Wireframe US16](<../docs/wireflows-mv/US 16F-Notificaciones de Recojo-Web.png>){width=90%}

![Wireframe US16](<../docs/wireflows-mv/US 16F-Notificaciones de Recojo-App.png>){width=90%}
...
![Wireframe US36](<../docs/wireflows-mv/US 37P-Calculador de Grosor-Web.png>){width=90%}

![Wireframe US36](<../docs/wireflows-mv/US 37P-Calculador de Grosor-App.png>){width=90%}

#### Control de Órdenes y Tablero Kanban
...
![](<../docs/taskflows-mv/US 05P-Seguimiento de Orden Web.png>){width=90%}

**Wireflow:**

![](<../docs/wireflows-mv/US 05P-Seguimiento de Orden Web-Web.png>){width=90%}

![](<../docs/wireflows-mv/US 05P-Seguimiento de Orden Web-App.png>){width=90%}
...
![](<../docs/taskflows-mv/US 07P-Consulta de Saldo.png>){width=90%}
...
#### US16 – Notificación de recojo

**Taskflow:**

![](<../docs/taskflows-mv/US 16F-Notificaciones de Recojo.png>){width=90%}

**Wireflow:**

![](<../docs/wireflows-mv/US 16F-Notificaciones de Recojo-Web.png>){width=90%}

![](<../docs/wireflows-mv/US 16F-Notificaciones de Recojo-App.png>){width=90%}
...
![Mockup US07 Consulta de saldo – Desktop](<../docs/mockups-mv/US 05P-Seguimiento de Orden Web-Web.png>){width=90%}

![Mockup US07 Consulta de saldo – Mobile](<../docs/mockups-mv/US 05P-Seguimiento de Orden Web-App.png>){width=90%}
...
![Mockup US16 Notificaciones de Recojo – Desktop](<../docs/mockups-mv/US 16F-Notificaciones de Recojo-Web.png>){width=90%}

![Mockup US16 Notificaciones de Recojo– Mobile](<../docs/mockups-mv/US 16F-Notificaciones de Recojo-App.png>){width=90%}
...
- **Happy Path:** El cliente abre detalles de pedido con deuda → el sistema calcula el saldo → muestra monto de adelanto y deuda exacta.
- **Unhappy Path:** El cliente consulta pedido pagado al 100% → el sistema detecta saldo cero → muestra etiqueta "Totalmente cancelado".

![User Flow US07 Consulta de Saldo – Desktop](<../docs/userflows-mv/US 05P-Seguimiento de Orden Web-Web.png>){width=90%}

![User Flow US07 Consulta de Saldo – Mobile](<../docs/userflows-mv/US 05P-Seguimiento de Orden Web-App.png>){width=90%}
...
- **Happy Path:** Empleado marca orden como "Listo" → sistema verifica email válido → envía correo automático con dirección y saldo.
- **Unhappy Path:** Sistema detecta email con formato erróneo al intentar notificar → marca notificación como "Fallida" en el CRM.

![User Flow US16 Notificaciones de Recojo – Desktop](<../docs/userflows-mv/US 16F-Notificaciones de Recojo-Web.png>){width=90%}

![User Flow US16 Notificaciones de Recojo – Mobile](<../docs/userflows-mv/US 16F-Notificaciones de Recojo-App.png>){width=90%}
